...
def main():
    ...
    data_file_one = importData("data_file_one", "DATA CWK SHOPPING DATA WEEK 4 FILE A.csv", "file_one")
    data_file_two = importData("data_file_two", "DATA CWK SHOPPING DATA WEEK 4 FILE B.csv", "file_two")
    ...
    """
    purchaseShopping(houses, items, availability, 3, shopping_list, monday_shopping, "1")
    ...
    #Complete shopping for Tuesday, visiting the 'best' store.
    ...
    #Make deliveries after Wednesday's shopping.
    for x in range(len(houses)):
    ...
    #Complete shopping for Thursday, visiting the 'worst' store.
    purchaseShopping(houses, items, availability, stores_dictionary[worst_store_char], shopping_list, thursday_shopping,
     remove_shopping)

    #Make final deliveries after Thursday's shopping.
    for x in range(len(houses)):
